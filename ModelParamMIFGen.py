...
magna = mu.MNP(id=-1, name="my_mnp_name", n_layers=_layers, layer_radius=_layer_radius, discretizations=(5,5,5), r_tuple=(4e-9, _particle_radius, _particle_radius), form='hcp')
...
filename = "MAGNA_U_C{0}_L{1}_SLD{2}_R{3}_SFB{4}.omf".format(_centers_per_layer, _layers, _sld, _particle_radius, _spin_flip_background)
